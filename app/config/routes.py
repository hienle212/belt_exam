...
routes['/books'] = 'Welcome#showbook'
routes['/users/<user_id>'] = 'Welcome#show_users'
routes['/books/<book_id>'] = 'Welcome#show_bookinfo'
routes['POST']['/books/add'] = 'Welcome#add_review'
routes['/books/adds'] = 'Welcome#add_reviewpage'
routes['POST']['/addbook'] = 'Welcome#add_book'
routes['/remove/<user_id>'] = 'Welcome#remove_review'
